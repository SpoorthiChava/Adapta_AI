...
import { AgentStatus, EmbeddingDataType, FlowNodeType, FlowStatus, KnowledgeBaseState, KnowledgeBaseStatus, KnowledgeBaseStorageType, KnowledgeBaseType, PromptTemplateType, SupplementalDataStorageLocationType } from "./enums";
import { type AgentKnowledgeBase, type AgentVersion, type KendraKnowledgeBaseConfiguration, type PromptInferenceConfiguration, type PromptTemplateConfiguration, type S3Location, type SqlKnowledgeBaseConfiguration, AgentFlowNodeConfiguration, AgentKnowledgeBaseSummary, AgentVersionSummary, AudioConfiguration, CollectorFlowNodeConfiguration, ConditionFlowNodeConfiguration, FlowConnection, FlowNodeInput, FlowNodeOutput, FlowValidation, InlineCodeFlowNodeConfiguration, InputFlowNodeConfiguration, IteratorFlowNodeConfiguration, KnowledgeBaseFlowNodeConfiguration, LambdaFunctionFlowNodeConfiguration, LexFlowNodeConfiguration, LoopControllerFlowNodeConfiguration, LoopInputFlowNodeConfiguration, OutputFlowNodeConfiguration, PromptFlowNodeConfiguration, RetrievalFlowNodeConfiguration, StorageFlowNodeConfiguration, VideoConfiguration } from "./models_0";
/**
