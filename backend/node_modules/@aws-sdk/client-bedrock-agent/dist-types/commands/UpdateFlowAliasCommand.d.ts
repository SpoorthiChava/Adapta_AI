...
declare const UpdateFlowAliasCommand_base: {
    new (input: UpdateFlowAliasCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateFlowAliasCommandInput, UpdateFlowAliasCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateFlowAliasCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateFlowAliasCommandInput, UpdateFlowAliasCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateFlowAliasCommand extends UpdateFlowAliasCommand_base {
