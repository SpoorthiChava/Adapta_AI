...
declare const CreateAgentActionGroupCommand_base: {
    new (input: CreateAgentActionGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAgentActionGroupCommandInput, CreateAgentActionGroupCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateAgentActionGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAgentActionGroupCommandInput, CreateAgentActionGroupCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateAgentActionGroupCommand extends CreateAgentActionGroupCommand_base {
