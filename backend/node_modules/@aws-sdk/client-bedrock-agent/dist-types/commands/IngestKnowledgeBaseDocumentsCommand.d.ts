...
declare const IngestKnowledgeBaseDocumentsCommand_base: {
    new (input: IngestKnowledgeBaseDocumentsCommandInput): import("@smithy/smithy-client").CommandImpl<IngestKnowledgeBaseDocumentsCommandInput, IngestKnowledgeBaseDocumentsCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: IngestKnowledgeBaseDocumentsCommandInput): import("@smithy/smithy-client").CommandImpl<IngestKnowledgeBaseDocumentsCommandInput, IngestKnowledgeBaseDocumentsCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class IngestKnowledgeBaseDocumentsCommand extends IngestKnowledgeBaseDocumentsCommand_base {
