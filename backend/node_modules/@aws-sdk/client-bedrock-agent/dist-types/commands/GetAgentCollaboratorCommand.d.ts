...
import type { GetAgentCollaboratorRequest, GetAgentCollaboratorResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetAgentCollaboratorCommand_base: {
    new (input: GetAgentCollaboratorCommandInput): import("@smithy/smithy-client").CommandImpl<GetAgentCollaboratorCommandInput, GetAgentCollaboratorCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetAgentCollaboratorCommandInput): import("@smithy/smithy-client").CommandImpl<GetAgentCollaboratorCommandInput, GetAgentCollaboratorCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetAgentCollaboratorCommand extends GetAgentCollaboratorCommand_base {
