...
declare const GetFlowCommand_base: {
    new (input: GetFlowCommandInput): import("@smithy/smithy-client").CommandImpl<GetFlowCommandInput, GetFlowCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetFlowCommandInput): import("@smithy/smithy-client").CommandImpl<GetFlowCommandInput, GetFlowCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetFlowCommand extends GetFlowCommand_base {
