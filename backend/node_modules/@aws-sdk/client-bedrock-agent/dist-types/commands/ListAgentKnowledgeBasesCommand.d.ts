...
import type { ListAgentKnowledgeBasesRequest, ListAgentKnowledgeBasesResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const ListAgentKnowledgeBasesCommand_base: {
    new (input: ListAgentKnowledgeBasesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentKnowledgeBasesCommandInput, ListAgentKnowledgeBasesCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListAgentKnowledgeBasesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentKnowledgeBasesCommandInput, ListAgentKnowledgeBasesCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListAgentKnowledgeBasesCommand extends ListAgentKnowledgeBasesCommand_base {
