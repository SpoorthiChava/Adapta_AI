...
import type { ListAgentCollaboratorsRequest, ListAgentCollaboratorsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListAgentCollaboratorsCommand_base: {
    new (input: ListAgentCollaboratorsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentCollaboratorsCommandInput, ListAgentCollaboratorsCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListAgentCollaboratorsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentCollaboratorsCommandInput, ListAgentCollaboratorsCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListAgentCollaboratorsCommand extends ListAgentCollaboratorsCommand_base {
