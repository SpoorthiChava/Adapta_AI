...
import type { UpdateFlowRequest, UpdateFlowResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const UpdateFlowCommand_base: {
    new (input: UpdateFlowCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateFlowCommandInput, UpdateFlowCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateFlowCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateFlowCommandInput, UpdateFlowCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
