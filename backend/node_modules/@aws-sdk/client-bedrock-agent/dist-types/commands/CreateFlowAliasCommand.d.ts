...
import type { CreateFlowAliasRequest, CreateFlowAliasResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const CreateFlowAliasCommand_base: {
    new (input: CreateFlowAliasCommandInput): import("@smithy/smithy-client").CommandImpl<CreateFlowAliasCommandInput, CreateFlowAliasCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateFlowAliasCommandInput): import("@smithy/smithy-client").CommandImpl<CreateFlowAliasCommandInput, CreateFlowAliasCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateFlowAliasCommand extends CreateFlowAliasCommand_base {
