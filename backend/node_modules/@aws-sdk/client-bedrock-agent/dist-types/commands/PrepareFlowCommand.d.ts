...
declare const PrepareFlowCommand_base: {
    new (input: PrepareFlowCommandInput): import("@smithy/smithy-client").CommandImpl<PrepareFlowCommandInput, PrepareFlowCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PrepareFlowCommandInput): import("@smithy/smithy-client").CommandImpl<PrepareFlowCommandInput, PrepareFlowCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PrepareFlowCommand extends PrepareFlowCommand_base {
