...
import type { ListAgentActionGroupsRequest, ListAgentActionGroupsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const ListAgentActionGroupsCommand_base: {
    new (input: ListAgentActionGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentActionGroupsCommandInput, ListAgentActionGroupsCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: ListAgentActionGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAgentActionGroupsCommandInput, ListAgentActionGroupsCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListAgentActionGroupsCommand extends ListAgentActionGroupsCommand_base {
