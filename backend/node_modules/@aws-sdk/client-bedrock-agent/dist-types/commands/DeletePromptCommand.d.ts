...
import type { DeletePromptRequest, DeletePromptResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const DeletePromptCommand_base: {
    new (input: DeletePromptCommandInput): import("@smithy/smithy-client").CommandImpl<DeletePromptCommandInput, DeletePromptCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeletePromptCommandInput): import("@smithy/smithy-client").CommandImpl<DeletePromptCommandInput, DeletePromptCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
