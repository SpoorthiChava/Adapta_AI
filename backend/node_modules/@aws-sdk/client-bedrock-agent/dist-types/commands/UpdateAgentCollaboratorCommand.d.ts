...
import type { UpdateAgentCollaboratorRequest, UpdateAgentCollaboratorResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateAgentCollaboratorCommand_base: {
    new (input: UpdateAgentCollaboratorCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAgentCollaboratorCommandInput, UpdateAgentCollaboratorCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateAgentCollaboratorCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAgentCollaboratorCommandInput, UpdateAgentCollaboratorCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateAgentCollaboratorCommand extends UpdateAgentCollaboratorCommand_base {
