...
import type { DeleteFlowVersionRequest, DeleteFlowVersionResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteFlowVersionCommand_base: {
    new (input: DeleteFlowVersionCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteFlowVersionCommandInput, DeleteFlowVersionCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DeleteFlowVersionCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteFlowVersionCommandInput, DeleteFlowVersionCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteFlowVersionCommand extends DeleteFlowVersionCommand_base {
