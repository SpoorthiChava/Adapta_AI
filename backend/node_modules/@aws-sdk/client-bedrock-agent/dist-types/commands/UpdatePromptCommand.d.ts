...
import type { UpdatePromptRequest, UpdatePromptResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const UpdatePromptCommand_base: {
    new (input: UpdatePromptCommandInput): import("@smithy/smithy-client").CommandImpl<UpdatePromptCommandInput, UpdatePromptCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdatePromptCommandInput): import("@smithy/smithy-client").CommandImpl<UpdatePromptCommandInput, UpdatePromptCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
