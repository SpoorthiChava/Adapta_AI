...
declare const GetFlowAliasCommand_base: {
    new (input: GetFlowAliasCommandInput): import("@smithy/smithy-client").CommandImpl<GetFlowAliasCommandInput, GetFlowAliasCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetFlowAliasCommandInput): import("@smithy/smithy-client").CommandImpl<GetFlowAliasCommandInput, GetFlowAliasCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetFlowAliasCommand extends GetFlowAliasCommand_base {
